# Autoformer-reproduce
## reproduce 
The data file and the checkpoints files are too large to submit to the repoisty..

To start, we can utilize the bash to execute:
```bash
# multivariate
...
```
For the baseline, such as Transformer, Reformer, Informer, the bash is similar.
